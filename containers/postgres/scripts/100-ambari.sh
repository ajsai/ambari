...
cd ~/
wget https://raw.githubusercontent.com/apache/ambari/release-2.7.4/ambari-server/src/main/resources/Ambari-DDL-Postgres-CREATE.sql
...
sed -i "s/\${ambariSchemaVersion}/2.7.4/g" Ambari-DDL-Postgres-CREATE.sql
